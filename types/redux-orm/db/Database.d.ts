 ...
 * @see {@link Table}
 */
export interface Database<I extends ORM.IndexedModelClasses<any>, Tables = { [K in keyof I]: Table<I[K]> }> {
    /**
     ...
     */
    query(querySpec: Database.QuerySpec, state: ORM.OrmState<I>): Database.QueryResult;
    ...
    update(updateSpec: Database.UpdateSpec, tx: Database.Transaction, state: ORM.OrmState<I>): Database.UpdateResult<I>;
...
export namespace Database {
     ...
     * Data update result.
     */
    interface UpdateResult<I extends ORM.IndexedModelClasses<any>, Payload extends object = {}> {
        status: UpdateStatus;
     ...
     * @see {@link Table}
     */
    interface SchemaSpec<I extends ORM.IndexedModelClasses<any>> {
        tables: { [K in keyof I]: Table.ModelTableOpts<I[K]> };
    }
}
 ...
 */
export function createDatabase<I extends ORM.IndexedModelClasses<any>>(schemaSpec: Database.SchemaSpec<I>): Database<I>;
